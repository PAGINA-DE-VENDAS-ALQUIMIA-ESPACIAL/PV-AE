...
export const HeadlineSection: React.FC<ProjectsGalleryProps> = ({ isDark = false }) => {
  return (
    <div className="w-full max-w-4xl mx-auto px-4 text-center flex flex-col items-center justify-center">
      ...
      >
        <h1 className={`text-[26px] sm:text-[32px] mt-0.5 sm:mt-1 font-normal tracking-tight leading-[28px] sm:leading-[32px] font-sans text-center max-w-[340px] sm:max-w-[650px] mx-auto ${
          isDark 
            ? 'text-white [text-shadow:_0_2px_10px_rgba(0,0,0,0.8)]' 
            : 'text-slate-950 [text-shadow:_0_1px_8px_rgba(255,255,255,0.9)]'
        }`}>
          Ideias <span className="font-serif italic font-normal">cocriadas</span>.<br />
          Espaços <span className="font-serif italic font-normal">transformados</span>.
        </h1>
